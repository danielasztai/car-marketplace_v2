<x-layout>
    <div class="w-screen h-[calc(100vh-17vh)] flex items-center justify-center">
        ...
        <div class="w-1/2 h-5/6 bg-gray-900 relative">
            ...
            <form action="/chat/{{4}}" method="POST">
                @csrf
                <div class="absolute bottom-0 w-full flex">
                    ...
                    <input type="submit" class="absolute right-2 top-1 bg-orange-600 p-2 rounded-lg text-white hover:bg-gray-900 hover:text-orange-600 font-semibold cursor-pointer" value="Send Message">
                </div>
            </form>
        </div>
    </div>
